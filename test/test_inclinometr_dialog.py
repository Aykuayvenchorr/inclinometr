...
__author__ = 'jjj@kkk.com'
__date__ = '2026-06-29'
__copyright__ = 'Copyright 2026, GPN-GEO'
...
class MainInclinometrDialogTest(unittest.TestCase):
    """Test dialog works."""

    def setUp(self):
        """Runs before each test."""
        self.dialog = MainInclinometrDialog(None)
...
if __name__ == "__main__":
    suite = unittest.makeSuite(MainInclinometrDialogTest)
